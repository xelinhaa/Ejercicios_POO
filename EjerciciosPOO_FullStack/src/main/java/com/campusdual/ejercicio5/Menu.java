...
//      · La dieta ya no será única si no que se guardará en una lista de dietas.
//              Esta lista tendrá un nombre para poder ser recuperado.
//              Será necesario cambiar el menú para gestionar esta lista.
//              Ahora en vez de crear/reemplazar dieta lo que haremos será:
...
//
//      · Se pueden dar de alta personas:
//              Las personas tendrán los siguientes atributos:
//              nombre, apellidos, peso, altura, edad y sexo.

//      · Las personas podrán tener asignadas una lista de dietas que se catalogarán
//        de lunes a domingo sacadas de la lista de dietas anterior.
...
//          2- Listar y Mostrar detalles de un paciente :
//                   Mostrará el detalle de un paciente así como todas sus dietas listadas de Lunes a domingo
//          3- Asignar una dieta: Muestra la lista de dietas general
//                   y puede asignarle una a un día de la semana del paciente.
//          4- Dar de baja un paciente: Elimina los datos de un paciente
//                   (No borra sus dietas asignadas dado que pueden estar asignadas a otro paciente)
//
